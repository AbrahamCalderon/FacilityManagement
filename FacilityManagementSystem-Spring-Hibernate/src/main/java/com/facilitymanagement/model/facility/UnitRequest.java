...
public class UnitRequest implements IRequest {
	...
	public UnitRequest(IComplexFacility facility, IAptUnit unit, Date dateRequested, Time timeRequested, 
	...
	public UnitRequest(IComplexFacility facility, Date dateRequested, Time timeRequested, 
			MaintenanceCat category, String description, RequestStatus requestStatus){
		this.facility = facility;
		this.dateRequested = dateRequested;
		this.timeRequested = timeRequested;
